...
class ReadyProductsScreen extends StatefulWidget {
  @override
  _ReadyProductsScreenState createState() => _ReadyProductsScreenState();
}

class _ReadyProductsScreenState extends State<ReadyProductsScreen> {
  @override
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => SubCategoryScreen(
              mainCategory: name,
              sourcePage: 'Ready Products',
            ), // Pass any data to the new screen if needed
          ),
        );
      },
      child: Card(
